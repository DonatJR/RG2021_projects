...
class CombineFollowPlanCaBehaviour():
    ...
    def __init__(self, animal_properties: AnimalProperties):
        ...
        self.collision_avoidance = CollisionAvoidanceBehaviour(
            animal_properties, small_fov=True)
    ...
    def __combine(self, own_pos, other_pos: PosAndOrientation, scan):
        _, omega_follow_plan = self.follow_plan.get_velocity_and_omega(
        ...
        omega_combined = self.__utility_function_behaviour_gates(
            omega_follow_plan, omega_ca)
