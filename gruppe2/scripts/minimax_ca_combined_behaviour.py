...
class CombineMinimaxCaBehaviour():
    ...
    #     # Problem: robot drives towards the wall, then collision avoidance takes effect, he drives away from the wall, then minimax takes effect again, which drives him towards the wall again.
